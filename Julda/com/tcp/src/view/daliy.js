...
var c6=0;
    ...
    function chk1_Click() {
        ...
        chk1.innerHTML = [
            "<img src='MAIN_2_checking.png' class='chk_img'>"
        ];
        if(c1==0) {
            gagy += 1;
            c1 += 1;
    ...
    function show_gagy() {
        if (window.gagy==1) {
            ...
            star.innerHTML=[
                "<img src='MAIN_2_star.png' id='star'>"
            ];
        }else if(window.gagy==6&&window.c1!=1&&window.c2!=1&&window.c3!=1&&window.c4!=1&&window.c5!=1&&window!=1);
    }
